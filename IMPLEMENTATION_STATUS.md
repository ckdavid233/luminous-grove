...
项目已经从单幕原型扩展为四幕可完成流程。运行时代码、剧情文档和测试都以 campaign v7 为准；
...
| 第二幕档案 | 已实装 | alignment 分支锚点顺序密码、倒影、Jolt 配重、跨时相铭名透镜、城门 |
...
- 当前 PCK SHA-256 为 `edb35607f5a9ee72a910fb00d8646c67b1ef1da2b2711e98bdc6b9a1157d097e`（538,721,376 bytes）；
- ZIP SHA-256 为 `fbe117662dbdccf3e4d3ffd25a6825b75f24deb89488e3e3cd6cb50da287573f`（576,234,357 bytes）；
- 不含签名、安装器、自动更新和崩溃上报；
